...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<groupId>com.it.demo.rest.example</groupId>
	<artifactId>spring-boot-2-jpa-with-hibernate-and-h2</artifactId>
	<version>0.0.1-SNAPSHOT</version>
	<packaging>jar</packaging>

	<firstName>spring-boot-2-jpa-with-hibernate-and-h2</firstName>
	...
	<repositories>
		<repository>
			...
			<firstName>Spring Snapshots</firstName>
		...
		<repository>
			...
			<firstName>Spring Milestones</firstName>
...
```java
package com.it.demo.jpa.hibernate.h2.example;
...
public class Student {
	...
	public Student(Long id, String firstName, String passportNumber) {
		super();
		this.id = id;
	...
	public Student(String firstName, String passportNumber) {
		super();
		this.firstName = firstName;
		this.passportNumber = passportNumber;
	}
	...
	public String toString() {
		return String.format("Student [id=%s, firstName=%s, passportNumber=%s]", id, firstName, passportNumber);
	}
